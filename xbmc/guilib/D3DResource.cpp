...
// static methods
void CD3DTexture::DrawQuad(const CPoint points[4], UTILS::Color4f color, CD3DTexture *texture, const CRect *texCoords, SHADER_METHOD options)
{
  unsigned numViews = 0;
...
void CD3DTexture::DrawQuad(const CRect &rect, UTILS::Color4f color, CD3DTexture *texture, const CRect *texCoords, SHADER_METHOD options)
{
  CPoint points[] =
  {
    { rect.x1, rect.y1 },
...
void CD3DTexture::DrawQuad(const CPoint points[4], UTILS::Color4f color, unsigned numViews, ID3D11ShaderResourceView **view, const CRect *texCoords, SHADER_METHOD options)
{
  XMFLOAT4 xcolor;
  xcolor.x = color.r();
  xcolor.y = color.g();
...
void CD3DTexture::DrawQuad(const CRect &rect, UTILS::Color4f color, unsigned numViews, ID3D11ShaderResourceView **view, const CRect *texCoords, SHADER_METHOD options)
{
  CPoint points[] =
  {
    { rect.x1, rect.y1 },

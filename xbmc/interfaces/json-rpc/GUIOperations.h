...
namespace JSONRPC
{
  ...
  public:
    ...
    static JSONRPC_STATUS SetWindowProperty(const std::string& method, ITransportLayer* transport, IClient* client, const CVariant& parameterObject, CVariant& result);
  private:

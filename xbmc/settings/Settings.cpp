...
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_COLORDEPTH;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_DISABLEGUISCALING;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_FORCECOLORFMT;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_OUTPUTRANGE;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_DYNAMICRANGE;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_SDR2HDRMAP;
constexpr const char* CSettings::SETTING_COREELEC_AMLOGIC_HDR2SDRMAP;
...
void CSettings::InitializeISettingCallbacks()
{
  ...
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_COLORDEPTH);
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_FORCECOLORFMT);
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_OUTPUTRANGE);
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_DYNAMICRANGE);
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_SDR2HDRMAP);
  settingSet.insert(CSettings::SETTING_COREELEC_AMLOGIC_HDR2SDRMAP);
